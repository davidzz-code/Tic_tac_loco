  ...
  const slides = [
    {
      ...
      imgSrc: ['/client/src/assets/how_to_play_1.webp'],
    },
    {
      emoji: '📍',
      title: '¿Cómo ganar?',
      text: 'Los tres en raya pequeños funcionan igual que el juego original',
      imgSrc: ['/client/src/assets/how_to_play_2.webp'],
    },
    {
      emoji: '📍',
      title: '¿Cómo ganar?',
      text: 'Cuando ganas un tres en raya pequeño, ese espacio en el tablero se bloquea con tu símbolo',
      imgSrc: ['/client/src/assets/how_to_play_3.webp', '/client/src/assets/how_to_play_4.webp'],
    },
    {
      emoji: '⚡',
      ...
      imgSrc: ['/client/src/assets/how_to_play_5.webp', '/client/src/assets/how_to_play_6.webp'],
    },
    {
      emoji: '🎲',
      ...
      imgSrc: ['/client/src/assets/how_to_play_7.webp', '/client/src/assets/how_to_play_8.webp'],
    },
  ];
