...
export default function HowToPlay({ setIsHowToPlayOpen }) {
  ...
  const slides = [
    ...
    },
    {
      ...
      imgSrc: ['/public/assets/how_to_play_5.webp', '/public/assets/how_to_play_6.webp'],
    },
    {
      emoji: '🎲',
      ...
      imgSrc: ['/public/assets/how_to_play_7.webp', '/public/assets/how_to_play_8.webp'],
    },
  ];
