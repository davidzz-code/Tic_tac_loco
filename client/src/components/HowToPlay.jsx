...
export default function HowToPlay({ setIsHowToPlayOpen }) {
  ...
  const slides = [
    ...
    },
    {
      ...
      imgSrc: ['/client/assets/how_to_play_5.webp', '/client/assets/how_to_play_6.webp'],
    },
    {
      emoji: '🎲',
      ...
      imgSrc: ['/client/assets/how_to_play_7.webp', '/client/assets/how_to_play_8.webp'],
    },
  ];
